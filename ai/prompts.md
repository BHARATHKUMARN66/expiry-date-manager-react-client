...
Start picking tasks from ./ai/tasks.md file. Work on one task at a time, provide implementation plan, implement it, wait for my closure confirmation, mark the task done, and move on to the next task. Do this until all the tasks are done in the tasks.md file.